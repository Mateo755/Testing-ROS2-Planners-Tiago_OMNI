...
def private_navigation(context, *args, **kwargs):
    ...
    rviz_config_pkg = 'omni_base_2dnav'
    if advanced_navigation == 'True':
        rviz_config_pkg = 'omni_base_advanced_2dnav'
    ...
    laser_bringup_launch = include_launch_py_description(
        pkg_name='omni_base_laser_sensors',
...
def public_navigation(context, *args, **kwargs):
    ...
    param_file = os.path.join(omni_base_2dnav, 'config', 'nav_public_sim_navfn.yaml')
